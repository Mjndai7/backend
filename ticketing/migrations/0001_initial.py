    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_section', models.CharField(blank=True, choices=[('Client', 'Client'), ('Consultant', 'Consultant'), ('Admin', 'Admin'), ('Infrastructure Specialist', 'Infrastructure Specialist'), ('Database Administrator', 'Database Administrator')], max_length=30, null=True)),
                ('urgent_status', models.BooleanField(default=False)),
                ('completed_status', models.BooleanField(default=False)),
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('resolved_by', models.DateTimeField(blank=True, null=True)),
