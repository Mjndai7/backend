...
class AccessToken:
    def __init__(self, appID=None, appCertificate=None, channelName='', uid=''):
        self.appID = appID or os.environ.get('AGORA_APP_ID')
        self.appCertificate = appCertificate or os.environ.get('AGORA_APP_CERTIFICATE')
